...
if payment >= payment_base:
    print(f"O aumento será de 10%, ou seja {payment_increase_for_bigger_than_base:.2f}")
else:
    print(f'O aumento será de 15%, ou seja, {payment_increase_for_smaller_than_base:.2f}')
